...
public class Huffman_Coding {
    ...
    //Method to number of characters supported in the alphabet based on what is being encoded, this can vary depending on language etc.
    private static final int ALPHABET_SIZE = 100000000;

    //Generating the frequency of the characters 
    private static int[] generateFrequency(String text,int N) {
    ...
    private static void getCodes(Node tree, String code, String[] codes){
        ...
        //If moving right of the binary tree adding a 1
    ...
    while (reader.hasNextLine()){ 
                // Ensures white space is not compromised
    ...
    private static String decompress(String compressedText, Node root){
        ...
        for(int i = 0; i < compressedText.length(); i++){
            ...
            if(compressedText.charAt(i) == '0') bit = bit.getLeft();
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] freq = generateFrequency(fileData,N);
